...
`const home = {
    label: "Home",
    title: "Giovanni Panella",
    description: "Portfolio website showcasing my work as an AI Engineer | PhD student",
    headline: <>AI Engineer and PhD student</>,
    subline: (
      <>
        I'm Giovanni, a PhD candidate at the University of Naples Federico II, where I research
        <br /> AI-powered applications for precision agriculture.
      </>
    ),
};`,
    language: "tsx",
